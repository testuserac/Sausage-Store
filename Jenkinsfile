pipeline {
    ...
    tools {
        ...
        nodejs 'node-15.4.0' // А NodeJS нужен для фронта
    }
    ...
    stages {
        ...
        stage('notifications') {
            steps {
	    sh 'curl -X POST -H "Content-type: application/json" --data \'{"text":"Сапрыкин Даниил собрал приложение."}\' https://hooks.slack.com/services/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'
            }
        }
    }
}
